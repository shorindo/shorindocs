 ...
 * 
 */
public class AuthenticateSettings extends PluginSettings {
    ...
    public List<DatabaseSchema> getSchemas() {
        ...
        schemas.add(repositoryService.loadSchema(getClass().getResourceAsStream("AuthenticateService.dsdl")));
